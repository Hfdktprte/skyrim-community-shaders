...
namespace Util
{
	...
	void RequestTimeJumpTransition() { RequestCelestialTransition(timeJumpTransitionRequested); }
	void RequestGameLoadTransition() { RequestCelestialTransition(gameLoadTransitionRequested); }
	...
	void CompleteCelestialTransition() { MarkCelestialTransitionComplete(); }
